...
export function ComponenteProyecto({ rol, proyecto }: Props) {
  return (
    <a href={`/proyecto/${proyecto.id}`} class='rounded-xl shadow-sm hover:shadow-md transition-all duration-200 border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600 cursor-pointer select-none'>
