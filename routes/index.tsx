...
import { InputBusqueda, InputIngresar } from '../components/Input.tsx'
...
import { ButtonAcciones, ButtonIngresar, ButtonTareaCompletada } from '../components/Button.tsx'
  ...
  return (
    <div class='pl-10 pb-7'>
      ...
      <div class='pr-10'>
        ...
        <InputIngresar color='sky-500' />
        <InputBusqueda color='green-400' />
        <InputIngresar color='green-400' />
        <InputBusqueda color='orange-400' />
        <InputIngresar color='orange-400' />
      </div>
