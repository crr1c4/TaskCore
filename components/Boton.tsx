...
export function BotonEmergencia(props: Props) {
  return (
    <button className='rounded border gap-2 border-rose-600 bg-rose-600 px-12 py-3 text-sm font-medium text-white hover:bg-rose-700 focus:ring-3 focus:outline-hidden flex items-center justify-around'>
      {props.children}
    </button>
  )
}
